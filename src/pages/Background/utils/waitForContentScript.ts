 ...
 * @param interval - The interval in ms to ping the tab.
 * @param timeout - The max timeout in ms to wait.
 * @returns Resolves when the content script responds, rejects if it times out.
 */
