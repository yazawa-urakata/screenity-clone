...
const SettingsMenu: React.FC<SettingsMenuProps> = (props) => {
  ...
  useEffect(() => {
    ...
    const ram = isMac ? 32 : Number((navigator as any).deviceMemory) || 4;
    setRAM(ram);
  }, []);
